...
public class LokasiActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String nama = mBundle.getString("NamaTaman");

        //menaruh data lokasi ke maps
        LatLng mLatLng = new LatLng(mLat, mLng);

        //memberi tanda dimaps
        googleMap.addMarker(new MarkerOptions().position(mLatLng).title(nama));
